...
@section('content')
                ...
                <div class="row align-items-center g-5">
                    <div class="col-lg-7">
                        <div class="banner-content">
                            ...
                            <p>A generous person will be enriched, and the one who provides water for others will himself be
                                satisfied.</p>
                            <div class="banner-btns d-flex flex-wrap">
                                <a data-blast="bgColor" href="#roadmap" class="default-btn move-top"><span>Roadmap</span>
                                </a>
                                <a href="about" class="default-btn move-right"><span>About Us</span> </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                                        ...
                                        <div class="nft-item home-4">
                                            <div class="nft-inner">
                                                ...
                                                <div class="nft-item-bottom">
                                                    <div class="nft-thumb">
                                                        <img loading="lazy" src="capadesu/assets/images/banner/2.jpg"
                                                            alt="nft-img">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nft-item home-4">
                                            <div class="nft-inner">
                                                ...
                                                <div class="nft-item-bottom">
                                                    <div class="nft-thumb">
                                                        <img loading="lazy" src="capadesu/assets/images/banner/3.jpg"
                                                            alt="nft-img">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nft-item home-4">
                                            <div class="nft-inner">
                                                ...
                                                <div class="nft-item-bottom">
                                                    <div class="nft-thumb">
                                                        <img loading="lazy" src="capadesu/assets/images/banner/4.jpg"
                                                            alt="nft-img">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="nft-item home-4">
                                            <div class="nft-inner">
                                                ...
                                                <div class="nft-item-bottom">
                                                    <div class="nft-thumb">
                                                        <img loading="lazy" src="capadesu/assets/images/banner/1.jpg"
                                                            alt="nft-img">
    ...
    <section id="roadmap" class="blog-section pb-120">
        <div class="container">
            <div class="section-header style-4">
                <div class="header-shape"><span></span></div>
                <h3>Roadmap</h3>
            ...
            <div class="section-wrapper">
                <div class="col-lg-12 text-center">
                    <div class="banner-image">
                        <img src="capadesu/assets/images/roadmap/petsypet-roadmap.jpg" alt="NFT Image">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row justify-content-center g-4">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="text-center">
                                <iframe data-aa='2016273' src='//ad.a-ads.com/2016273?size=300x250'
                                    style='width:300px; height:250px; border:0px; padding:0; overflow:hidden; background-color: transparent;'></iframe>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="nft-item home-4 cat-item">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-2 col-sm-4 col-6">
                        <div class="wallet-item home-4">
                            <div class="wallet-item-inner text-center">
                                <div class="wallet-thumb">
                                    <a href="https://twitter.com/PetsypetNFT" target="_blank">
                                        <img src="capadesu/assets/images/sponsor/twitter.png" alt="wallet-img">
                                    </a>
                                </div>
                                <div class="wallet-content">
                                    <h5><a href="https://twitter.com/PetsypetNFT" target="_blank">Twitter</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-2 col-sm-4 col-6">
                        <div class="wallet-item home-4">
                            <div class="wallet-item-inner text-center">
                                <div class="wallet-thumb">
                                    <a href="https://www.instagram.com/PetsypetNFT/" target="_blank">
                                        <img src="capadesu/assets/images/sponsor/ig.png" alt="wallet-img">
                                    </a>
                                </div>
                                <div class="wallet-content">
                                    <h5><a href="https://www.instagram.com/PetsypetNFT/" target="_blank">Instagram</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
